...
# Write to CSV for analysis into Analysis folder
write.csv(final_data, "Analysis/Pairwise_Corr_FC.csv", row.names = FALSE)
...
#Write to .csv file in the /analysis folder
write.csv(confound_var_final, "Analysis/Confounding_variables.csv", row.names = FALSE)