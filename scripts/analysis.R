...
plot_ci(x_data, "Confidence Interval for Canonical Directions (X)", "../results/Analysis/Confidence Intervals/CI_3PC_B.png")
plot_ci(y_data, "Confidence Interval for Canonical Directions (Y)", "../results/Analysis/Confidence Intervals/CI_3PC_G.png", y_limits = c(-8, 8))
non_zero_x <- list(
